/**
 * Momie 3D avec Texture de Bandelettes via Bruit de Perlin (Version Simplifiée)
 * Instructions : Cliquez et glissez la souris pour faire tourner la momie.
 */
...
void setupLighting() {
  ...
  pointLight(255, 240, 220, -200, -200, 200);
  directionalLight(150, 140, 130, 0.5, 0.75, -1);
}
